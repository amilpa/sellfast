...
// with int pk
// CREATE TABLE IF NOT EXISTS user_data(user_id BIGINT PRIMARY KEY,name varchar(20) NOT NULL,email varchar(30) UNIQUE NOT NULL,imageURL varchar(300) NULL,balance INT NULL,rating INT NULL)
